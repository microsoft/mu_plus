...
**/
  ...
  // NOTE: the digital signature was not regenerated for this malformed data, so it will not validate
  // However, this is fine because it is used in a string parsing test case that does not check the signature
  CONST  UINT8   mSigned_policy_NULL_in_OEM_string[] = {
          ...
          0x6f, 0x00, 0x6e, 0x00, 0x74, 0x00, 0x6f, 0x00, 0x73, 0x00, 0x6f, 0x00, 0x00, 0x00, 0x43, 0x00,
