...
typedef enum {
  ...
  DFCI_IDENTITY_UNSIGNED_LOCAL = 0x02, // Same as Local user, but to tailor operations for unsigned settings
  DFCI_IDENTITY_RESERVED       = 0x04, // Reserved for future use
  ...
  DFCI_IDENTITY_NOT_SPECIFIED  = 0xFE,
...
#define DFCI_PERMISSION_MASK__DEFAULT_UNSIGNED   (DFCI_IDENTITY_LOCAL | DFCI_IDENTITY_UNSIGNED_LOCAL)
