  ...
  )
{
  ...
  *(UINT32 *)pFontPackages = CollectionSize;
  ...
  //
  mSWMHiiHandle = HiiAddPackages (
                    &mSWMHiiPackageListGuid,
                    mImageHandle,
                    pFontPackages,
  ...
  )
{
  ...
  Status = mRenderingEngine->MoveMousePointer (
                               mRenderingEngine,
                               (UINT32)PositionX,
                               (UINT32)PositionY
                               );
  ...
  )
{
  ...
  Status = mRenderingEngine->ShowMousePointer (
                               mRenderingEngine,
                               FALSE
                               );
...
WINMGR_CLIENT *
FilterPointerState (
  IN MS_SWM_ABSOLUTE_POINTER_STATE  *PointerState
  )
{
  WINMGR_CLIENT  *pList;
...
**/
static EFI_STATUS
AddAbsolutePointerInterfaceToWatchList (
...
**/
static EFI_STATUS
RemoveAbsolutePointerInterfaceFromWatchList (
  IN EFI_HANDLE  Controller,
  ...
  )
{
  ...
  //
  Status = mRenderingEngine->SetMousePointer (
                               mRenderingEngine,
  ...
  )
{
  ...
  while (pList != NULL) {
    if (gBS->CheckEvent (pList->AbsolutePointer->WaitForInput) == EFI_SUCCESS) {
      ...
      Status = pList->AbsolutePointer->GetState (
                                         pList->AbsolutePointer,
                                         &PointerState
                                         );
  ...
  )
{
  ...
  //
  Status = AddAbsolutePointerInterfaceToWatchList (
             Controller,
  ...
  )
{
  ...
  //
  Status = RemoveAbsolutePointerInterfaceFromWatchList (
             Controller,
             &bNeedsMousePointer
             );
