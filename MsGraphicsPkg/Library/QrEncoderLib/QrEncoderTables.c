...
CONST  QrTableEntry  gQrTable[QR_TABLE_ENTRIES] = {
  // Combination of data from Table 7 and Table 9 in ISO 18004
...
CONST UINT8  gAlphaNumerics[QR_ALPHA_TABLE_SIZE] = {
  // ISO 18004:2015 Table 5 Encoding for Alphanumeric mode
...
CONST UINT8  gLengthBits[QR_LENGTH_ENTRIES][QR_ENCODER_ENTRIES] = {
  // ISO 18004:2015 Table 3 Number of Bits in the length indicator
...
CONST UINT16  gFormatInfo[QR_EC_LEVELS][QR_MASK_PATTERNS] = {
  // Table C.1 ISO 18004:2015
...
CONST UINT32  gVersionInfo[QR_CODES-6] = {
  // Table D.1 ISO 18004:2015
...
CONST UINT8  gAlignmentLocations[QR_CODES - 1][QR_MAX_LOCATIONS] = {
  // ISO 18004:2015 Table E.1 Location of alignment patterns
  /*   2   */ { 6, 18, 0,  0,  0,   0,   0   },
  /*   3   */ { 6, 22, 0,  0,  0,   0,   0   },
  /*   4   */ { 6, 26, 0,  0,  0,   0,   0   },
  /*   5   */ { 6, 30, 0,  0,  0,   0,   0   },
...
CONST UINT8  *gGeneratorPolynomials[QR_MAX_GEN_POLYS] = {
  // ISO 18004:2015 Table A.1 - ISO has a sparse list up to 68.
