  ...
  )
{
  ...
  switch (ulCharacter) {
    case L'-':  RetVal = NTXML_RAWTOKEN_DASH;
      break;
    case L'.':  RetVal = NTXML_RAWTOKEN_DOT;
      break;
    case L'=':  RetVal = NTXML_RAWTOKEN_EQUALS;
      break;
    case L'/':  RetVal = NTXML_RAWTOKEN_FORWARDSLASH;
      break;
    case L'>':  RetVal = NTXML_RAWTOKEN_GT;
      break;
    case L'<':  RetVal = NTXML_RAWTOKEN_LT;
      break;
    case L'?':  RetVal = NTXML_RAWTOKEN_QUESTIONMARK;
      break;
    case L'\"': RetVal = NTXML_RAWTOKEN_DOUBLEQUOTE;
      break;
    case L'\'': RetVal = NTXML_RAWTOKEN_QUOTE;
      break;
    case L'[':  RetVal = NTXML_RAWTOKEN_OPENBRACKET;
      break;
    case L']':  RetVal = NTXML_RAWTOKEN_CLOSEBRACKET;
      break;
    case L'!':  RetVal = NTXML_RAWTOKEN_BANG;
      break;
    case L'(':  RetVal = NTXML_RAWTOKEN_OPENPAREN;
      break;
    case L')':  RetVal = NTXML_RAWTOKEN_CLOSEPAREN;
      break;
    case L'{':  RetVal = NTXML_RAWTOKEN_OPENCURLY;
      break;
    case L'}':  RetVal = NTXML_RAWTOKEN_CLOSECURLY;
      break;
    case L':':  RetVal = NTXML_RAWTOKEN_COLON;
      break;
    case L';':  RetVal = NTXML_RAWTOKEN_SEMICOLON;
      break;
    case L'_':  RetVal = NTXML_RAWTOKEN_UNDERSCORE;
      break;
    case L'&':  RetVal = NTXML_RAWTOKEN_AMPERSAND;
      break;
    case L'#':  RetVal = NTXML_RAWTOKEN_POUNDSIGN;
      break;
    case L'%':  RetVal = NTXML_RAWTOKEN_PERCENT;
      break;
    case 0x09:
    case 0x0a:
    case 0x0d:
    case 0x20:  RetVal = NTXML_RAWTOKEN_WHITESPACE;
      break;
...
BOOLEAN
RtlRawXmlTokenizer_IsValidPubIdCharacter (
  IN UINT32   ulChar,
