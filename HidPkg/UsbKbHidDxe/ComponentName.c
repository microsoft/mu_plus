/** @file
  UEFI Component Name(2) protocol implementation for USB HID Keyboard driver.
...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME_PROTOCOL  gUsbKbHidComponentName = {
  ...
  )
{
  ...
  UsbKbDev = USB_KB_HID_DEV_FROM_THIS (HidKeyboard);
