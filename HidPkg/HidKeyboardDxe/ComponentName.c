/** @file
  UEFI Component Name(2) protocol implementation for HID Keyboard driver.
...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME_PROTOCOL  mHidKeyboardComponentName = {
  ...
  )
{
  ...
  HidKbDev = HID_KB_DEV_FROM_THIS (SimpleTxtIn);
