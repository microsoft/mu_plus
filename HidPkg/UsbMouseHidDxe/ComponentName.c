...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME_PROTOCOL  gUsbMouseHidComponentName = {
  ...
  )
{
  ...
  UsbMouseHidDev = USB_MOUSE_HID_DEV_FROM_HID_POINTER_PROTOCOL (HidPointerProtocol);

  return LookupUnicodeString2 (
           Language,
           This->SupportedLanguages,
           UsbMouseHidDev->ControllerNameTable,
           ControllerName,
           (BOOLEAN)(This == &gUsbMouseHidComponentName)
           );
}
