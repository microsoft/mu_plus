  ...
  )
{
  ...
  AddTestCase (PagingSuite, L"Write Access to SMM Entry Point should be prevented", L"Security.SMMPaging.EntryPointShouldNotBeAccessible", AccessToSmmEntryPointShouldBePrevented, LocateSmmCommonCommBuffer, NULL, NULL);
