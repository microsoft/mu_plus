//! Temporary test application for benchmarking UEFI boot services.
//!
//! This crate is used for performance testing and does not implement any HID input handling.
//!
//! ## License
//!
