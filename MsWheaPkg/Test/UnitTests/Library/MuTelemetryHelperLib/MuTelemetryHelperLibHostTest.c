  ...
  )
{
  ...
  UT_ASSERT_NOT_EFI_ERROR(LogTelemetry(FALSE,
                                        NULL,
                                        TEST_RSC_MISC_C,
                                        NULL,
                                        NULL,
  ...
  will_return(ReportStatusCodeEx, EFI_SUCCESS);
  UT_ASSERT_NOT_EFI_ERROR(LogTelemetry(TRUE,
                                        &gEfiCallerIdGuid,
                                        TEST_RSC_MISC_C,
                                        &mTestGuid2,
                                        &mTestGuid3,
  ...
  )
{
  ...
  will_return(ReportStatusCodeEx, EFI_SUCCESS);
  UT_ASSERT_NOT_EFI_ERROR(LogTelemetryEx(FALSE,
                                          NULL,
                                          TEST_RSC_MISC_C,
                                          NULL,
                                          NULL,
  ...
  will_return(ReportStatusCodeEx, EFI_SUCCESS);
  UT_ASSERT_NOT_EFI_ERROR(LogTelemetryEx(TRUE,
                                          &gEfiCallerIdGuid,
                                          TEST_RSC_MISC_C,
                                          &mTestGuid2,
                                          &mTestGuid3,
  ...
  )
{
  ...
  // Don't pass a buffer.
  //
  UT_ASSERT_TRUE(EFI_ERROR(LogTelemetryEx(FALSE,
                                          NULL,
                                          TEST_RSC_MISC_C,
                                          NULL,
                                          NULL,
