...
#define EX_PERSIST_I2C_BIT         BIT11  // I2C occurred
#define EX_PERSIST_OTHER_EX_BIT    BIT15  // An unknown exception occurred

#define EX_PERSIST_EXCEPTION_BITS  (EX_PERSIST_PF_HIT_BIT | EX_PERSIST_I2C_BIT | EX_PERSIST_OTHER_EX_BIT)
      ...
      switch (ExceptionBits) {
        ...
        case EX_PERSIST_OTHER_EX_BIT:
          *Exception = ExceptionPersistOther;
          break;
        case EX_PERSIST_I2C_BIT:
          *Exception = ExceptionPersistI2C;
          break;
        case 0:
  ...
  )
{
  ...
  switch (Exception) {
    case ExceptionPersistPageFault:
      ...
      break;
    case ExceptionPersistI2C:
      ExceptionBit = EX_PERSIST_I2C_BIT;
      break;
